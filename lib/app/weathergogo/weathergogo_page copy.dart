...
//                 children: [
//                   Text('날씨정보', style: semiboldText.copyWith(fontSize: 24.0)),
//                   const Gap(10),
//                   ElevatedButton(
...
//                     child: const Row(
//                       children: [
//                         // Text('동네라운지 ', style: semiboldText.copyWith(fontSize: 13.0)),
//                         ShimmeringText(
//                           text: '동네라운지 ',
//                           fontSize: 13.0,
...
//                         ),
//                         const Icon(Icons.arrow_forward_ios, size: 13.0, color: Colors.amber),
//                       ],
//                     ),
//                   ),
//                   SizedBox(
...
//                       child: Text("라운지", style: semiboldText.copyWith(fontSize: 9.0)),
//                     ),
//                   )
//                 ],
//               ),
