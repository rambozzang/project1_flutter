...
// class VideoScreenPage5 extends StatefulWidget {
//   const VideoScreenPage5({super.key, required this.index, required this.data});
...
//   @override
//   State<VideoScreenPage5> createState() => VideoScreenPage5State();
// }

// class VideoScreenPage5State extends State<VideoScreenPage5> {
//   bool initPlay = false;
...
//     lo.g('VideoPlayer5 initialization  _initController()');
...
//     );
//     lo.g('VideoPlayer5 initialization  _loadVideoSource()');
...
//     _controller.pause();
//     lo.g('VideoPlayer5 initialization time: ${stopwatch.elapsedMilliseconds}ms');
//     timeDesc.value = '${stopwatch.elapsedMilliseconds}ms';
//   }

//   void _onPlaybackStatusChanged() {
//     isPlay.value = _controller.playbackInfo?.status == PlaybackStatus.playing;
//   }

//   void _onPlaybackPositionChanged() {
//     position = Duration(seconds: _controller.playbackInfo?.position ?? 0);
//     final duration = _controller.videoInfo?.duration ?? 0;
//     if (duration > 0) {
//       progress.value = (position.inSeconds / duration * 100).clamp(0.0, 100.0);
//     }
...
//                 return value ? const SizedBox.shrink() : buildLoading();
//               },
//             ),
...
//         _controller.play();
//         _controller.setVolume(Get.find<VideoListCntr>().soundOff.value ? 0 : 1);
