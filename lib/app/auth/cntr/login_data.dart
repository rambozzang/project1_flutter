...
class LoginRes {
  ...
  @override
  String toString() {
    return 'LoginRes(custId: $custId, nickNm: $nickNm, custNm: $custNm, email: $email, hpNo: $hpNo, birthday: $birthday, fcmId: $fcmId, chatId: $chatId, provider: $provider, profilePath: $profilePath, accessToken: $accessToken, refreshToken: $refreshToken, custData: $custData)';
  }
