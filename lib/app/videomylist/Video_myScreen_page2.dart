...
// class VideoMySreenPage2 extends StatefulWidget {
//   const VideoMySreenPage2({super.key, required this.data, required this.index});

//   final BoardWeatherListData data;
//   final int index;

//   @override
//   State<VideoMySreenPage2> createState() => _VideoMySreenPage2State();
// }

// class _VideoMySreenPage2State extends State<VideoMySreenPage2> {
...
//       formatHint: Platform.isAndroid ? VideoFormat.dash : VideoFormat.hls, // HLS 형식임을 명시
//     );
...
//     lo.g('ChewiePlayer initialization time: ${stopwatch.elapsedMilliseconds}ms');
//     initialized.value = true;
//   }
...
//   void _videoListener() {
//     isPlay.value = _videoPlayerController.value.isPlaying;
//     final duration = _videoPlayerController.value.duration;
//     position = _videoPlayerController.value.position;
//     if (duration != Duration.zero) {
//       progress.value = (position.inMilliseconds / duration.inMilliseconds * 100).clamp(0.0, 100.0);
//     }
//     if (isPlay.value) {
//       updateCount();
//     }
...
//                                     if (value) {
//                                       _videoPlayerController.play();
//                                       Get.find<VideoMyinfoListCntr>().soundOff.value
