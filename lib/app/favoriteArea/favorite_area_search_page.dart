...
class FavoriteAreaSearchPage extends StatefulWidget {
  const FavoriteAreaSearchPage({super.key, required this.onSelectClick});
  final Function(GeocodeData) onSelectClick;

  @override
  State<FavoriteAreaSearchPage> createState() => _FavoriteAreaSearchPageState();
}

class _FavoriteAreaSearchPageState extends State<FavoriteAreaSearchPage> {
