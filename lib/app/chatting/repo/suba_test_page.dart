...
class SupaTestPage extends StatefulWidget {
  const SupaTestPage({super.key});

  @override
  State<SupaTestPage> createState() => _SupaTestPageState();
}

class _SupaTestPageState extends State<SupaTestPage> {
  User? _user;
  @override
  void initState() {
    _getAuth();
